...
// api/[[path]].js
var API_BASE = "https://api.nmb.best/api/";
...
// image/[[path]].js
var CDN_BASE = "https://image.nmb.best/";
...
// post/[[path]].js
var MAIN_SITE = "https://www.nmbxd1.com";
...
// thumb/[[path]].js
var CDN_BASE2 = "https://image.nmb.best/";
async function onRequest4(context) {
  ...
  const upstream = `${CDN_BASE2}thumb/${path}${url.search}`;
  const upstreamRes = await fetch(upstream, {
    cf: { cacheTtl: 86400, cacheEverything: true }
  });
  const responseHeaders = new Headers(upstreamRes.headers);
...
// ../.wrangler/tmp/pages-cCgwEU/functionsRoutes-0.4367654784757793.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
